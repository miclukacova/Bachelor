...
write.csv(train_leafs_log, "/Users/michaelalukacova/Bachelor1/Data/train_leafs.csv", row.names=FALSE)
write.csv(train_roots_log, "/Users/michaelalukacova/Bachelor1/Data/train_roots.csv", row.names=FALSE)
write.csv(train_wood_log, "/Users/michaelalukacova/Bachelor1/Data/train_wood.csv", row.names=FALSE)
